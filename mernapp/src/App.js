...
import Home from './screens/Home'; // Assuming Home.js is in the src/screens directory
import Login from './screens/Login'; // Assuming Login.js is in the src/screens directory
import Signup from './screens/Signup'; // Assuming Signup.js is in the src/screens directory
import Navbar from './Components/Navbar'; // Assuming Navbar.js is in the Components directory
